...
import { MapPin, ThumbsUp, Loader } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-gray-600 font-medium">Loading live data from Firebase...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-600 mb-8">Live data from Firebase — updates in real time!</p>
        ...
        {filtered.length === 0 ? (
          ...
          <div className="flex flex-col gap-4">
            {filtered.map(issue => {
              ...
              return (
                <div key={issue.id} className="bg-white rounded-2xl shadow-sm p-5 flex flex-col sm:flex-row sm:items-center gap-4">
